...
// Partially edited by Dongyeob Han, May 2024.
// For geometry shader usage
...
struct Program {
	...
	inline void loadShaders( const char* vsFilename, const char* fsFilename, const char* gsFilename ) {
		cleanUp();
